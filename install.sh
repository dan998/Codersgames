...
echo -e "\e[032m" "Please Don't copy the Code And Give creadits to the Coding Family"


clear


echo "play Games in termux pleaee enjoy"
...
cd && echo "if [ -x /data/data/com.termux/files/usr/libexec/termux/command-not-found ]; then
 ...
 PS1='$'
alias games='cd && cd Codersgames && bash games.sh'" > /data/data/com.termux/files/usr/etc/bash.bashrc

echo "Thanks for supporting the Coding Family" | lolcat -a
echo ""
