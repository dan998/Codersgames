...
def game():
    ...
    for i in range(10):
        printBoard(theBoard)
        print("It's your turn coder," + turn + ".Move to which place?")
        ...
        if theBoard[move] == ' ':
            ...
            print("That place is already filled are you blind.\nMove to which place?")
            continue
        ...
        if count >= 5:
            if theBoard['1'] == theBoard['2'] == theBoard['3'] != ' ':  # across the top
                printBoard(theBoard)
                print("\nLevel Complete.\n")
                print(" **** " + turn + " congradulation you won. ****")
                break
    ...
    restart = input("Do want to play Again with the coding family?(y/n)")
